...
pub const PRIMARY: Color = Color::oklch(0.795, 0.184, 86.047);
pub const PRIMARY_FOREGROUND: Color = Color::oklch(0.421, 0.095, 57.708);
...
pub const RING: Color = Color::oklch(0.795, 0.184, 86.047);
...
pub const SIDEBAR_PRIMARY: Color = Color::oklch(0.795, 0.184, 86.047);
pub const SIDEBAR_PRIMARY_FOREGROUND: Color = Color::oklch(0.421, 0.095, 57.708);
...
pub const SIDEBAR_RING: Color = Color::oklch(0.795, 0.184, 86.047);
