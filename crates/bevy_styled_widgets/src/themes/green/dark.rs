...
pub const PRIMARY: Color = Color::oklch(0.696, 0.17, 162.48);
pub const PRIMARY_FOREGROUND: Color = Color::oklch(0.393, 0.095, 152.535);
...
pub const BORDER: Color = Color::oklcha(1.0, 0.0, 0.0, 0.10);
pub const INPUT: Color = Color::oklcha(1.0, 0.0, 0.0, 0.15);
pub const RING: Color = Color::oklch(0.527, 0.154, 150.069);
pub const CHART_1: Color = Color::oklch(0.488, 0.243, 264.376);
pub const CHART_2: Color = PRIMARY;
