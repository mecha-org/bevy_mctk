...
pub const CARD_FOREGROUND: Color = Color::oklch(0.141, 0.005, 285.823);
pub const POPOVER: Color = Color::oklch(1.0, 0.0, 0.0);
pub const POPOVER_FOREGROUND: Color = Color::oklch(0.141, 0.005, 285.823);
pub const PRIMARY: Color = Color::oklch(0.623, 0.214, 259.815);
pub const PRIMARY_FOREGROUND: Color = Color::oklch(0.97, 0.014, 254.604);
...
pub const MUTED: Color = Color::oklch(0.967, 0.001, 286.375);
pub const MUTED_FOREGROUND: Color = Color::oklch(0.552, 0.016, 285.938);
pub const ACCENT: Color = Color::oklch(0.967, 0.001, 286.375);
pub const ACCENT_FOREGROUND: Color = Color::oklch(0.21, 0.006, 285.885);
pub const DESTRUCTIVE: Color = Color::oklch(0.577, 0.245, 27.325);
pub const BORDER: Color = Color::oklch(0.92, 0.004, 286.32);
pub const INPUT: Color = Color::oklch(0.92, 0.004, 286.32);
pub const RING: Color = Color::oklch(0.623, 0.214, 259.815);
...
pub const SIDEBAR_FOREGROUND: Color = Color::oklch(0.141, 0.005, 285.823);
pub const SIDEBAR_PRIMARY: Color = Color::oklch(0.623, 0.214, 259.815);
pub const SIDEBAR_PRIMARY_FOREGROUND: Color = Color::oklch(0.97, 0.014, 254.604);
pub const SIDEBAR_ACCENT: Color = Color::oklch(0.967, 0.001, 286.375);
pub const SIDEBAR_ACCENT_FOREGROUND: Color = Color::oklch(0.21, 0.006, 285.885);
pub const SIDEBAR_BORDER: Color = Color::oklch(0.92, 0.004, 286.32);
pub const SIDEBAR_RING: Color = Color::oklch(0.623, 0.214, 259.815);
