...
pub const PRIMARY: Color = Color::oklch(0.546, 0.245, 262.881);
pub const PRIMARY_FOREGROUND: Color = Color::oklch(0.379, 0.146, 265.522);
...
pub const RING: Color = Color::oklch(0.488, 0.243, 264.376);
...
pub const SIDEBAR_PRIMARY: Color = Color::oklch(0.546, 0.245, 262.881);
pub const SIDEBAR_PRIMARY_FOREGROUND: Color = Color::oklch(0.379, 0.146, 265.522);
...
pub const SIDEBAR_RING: Color = Color::oklch(0.488, 0.243, 264.376);
