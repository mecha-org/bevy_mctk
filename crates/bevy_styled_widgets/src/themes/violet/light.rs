...
pub const PRIMARY: Color = Color::oklch(0.606, 0.25, 292.717);
pub const PRIMARY_FOREGROUND: Color = Color::oklch(0.969, 0.016, 293.756);
...
pub const RING: Color = Color::oklch(0.606, 0.25, 292.717);
...
pub const SIDEBAR_PRIMARY: Color = Color::oklch(0.606, 0.25, 292.717);
pub const SIDEBAR_PRIMARY_FOREGROUND: Color = Color::oklch(0.969, 0.016, 293.756);
...
pub const SIDEBAR_RING: Color = Color::oklch(0.606, 0.25, 292.717);
