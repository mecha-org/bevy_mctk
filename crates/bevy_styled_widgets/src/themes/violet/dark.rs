...
pub const POPOVER: Color = Color::oklch(0.21, 0.006, 285.885);
pub const POPOVER_FOREGROUND: Color = Color::oklch(0.985, 0.0, 0.0);
pub const PRIMARY: Color = Color::oklch(0.541, 0.281, 293.009);
...
pub const SIDEBAR: Color = Color::oklch(0.21, 0.006, 285.885);
pub const SIDEBAR_FOREGROUND: Color = Color::oklch(0.985, 0.0, 0.0);
pub const SIDEBAR_PRIMARY: Color = Color::oklch(0.541, 0.281, 293.009);
pub const SIDEBAR_PRIMARY_FOREGROUND: Color = Color::oklch(0.969, 0.016, 293.756);
pub const SIDEBAR_ACCENT: Color = Color::oklch(0.274, 0.006, 286.033);
pub const SIDEBAR_ACCENT_FOREGROUND: Color = Color::oklch(0.985, 0.0, 0.0);
pub const SIDEBAR_BORDER: Color = Color::oklcha(1.0, 0.0, 0.0, 0.1);
pub const SIDEBAR_RING: Color = Color::oklch(0.541, 0.281, 293.009);
